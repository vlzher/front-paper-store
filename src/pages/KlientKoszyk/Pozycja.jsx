...
const Pozycja = ({onClickFunc, imageUrl, positionName, positionPrice}) => {
  ...
  return (
    ...
    >
      ...
      <div className="pt-2 w-full flex flex-col items-center h-8">
        ...
        <div className="text-xl font-semibold text-red-700">{positionPrice}</div>
          <div className={"w-full flex items-center justify-center pt-5"}>
              <Button color={`${!isAdded ? 'failure' : 'green'}`} >
